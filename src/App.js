...
const NvidiaGPUShowcase = () => {
  ...
  const components = [
    {
      ...
      color: "#76b900",
      icon: "⚡",
      details: "Revolutionary 3nm FinFET process technology delivering unprecedented transistor density and energy efficiency. Features 80 billion transistors with specialized AI compute units and advanced power management.",
      specs: "• 80B transistors\n• 3nm Samsung FinFET\n• 2.5 GHz boost clock\n• 50% power reduction vs 5nm\n• Advanced gate-all-around architecture",
      thermal: "52°C",
      maxTemp: "85°C",
      powerSavings: "18%",
      impact: "Core architecture enables 2.5x performance-per-watt improvement while maintaining thermal efficiency.",
      validation: "Beta tested by Microsoft Azure, Google Cloud, AWS, and Meta AI Research",
    ...
    },
    {
      ...
      color: "#00bfff",
      icon: "💾",
      details: "Next-generation HBM3e memory with integrated ML-based power gating controller. Intelligent memory subsystem predicts access patterns and dynamically powers down unused banks, achieving 900 GB/s bandwidth at 30% lower power.",
      specs: "• 900 GB/s bandwidth\n• 96GB total capacity (4x24GB stacks)\n• 30% power savings vs HBM3\n• AI prediction engine\n• Sub-microsecond bank switching",
      thermal: "48°C",
      maxTemp: "85°C",
      powerSavings: "12%",
      impact: "ML-based memory controller reduces memory subsystem power by 30% while maintaining full bandwidth for AI workloads.",
      validation: "Validated across transformer models (GPT, BERT), computer vision (ResNet, ViT), and recommendation systems",
      timeline: "Development: Q1 2024 • Integration: Q3 2024 • Production: Q1 2025",
    ...
    },
    {
      ...
      color: "#00ffff",
      icon: "❄️",
      details: "Advanced two-phase cooling system with 10,000 precision-etched micro-channels. Distributes heat 3x faster than traditional copper heat spreaders, maintaining 65°C junction temperature under sustained AI training loads vs 85°C in H100.",
      specs: "• 10,000 micro-channels\n• 65°C max junction temp\n• 500W+ heat dissipation\n• 20°C temperature reduction\n• 2-phase liquid cooling technology",
      thermal: "45°C",
      maxTemp: "75°C",
      powerSavings: "8%",
      impact: "69% improvement in thermal conductivity enables sustained boost clocks and extends component lifespan by 40%.",
      validation: "Thermal testing completed at Azure, GCP, and AWS data centers under production workloads",
    ...
    },
    {
      ...
      color: "#ff6b35",
      icon: "🧠",
      details: "Dedicated RISC-V ML chip running real-time power prediction models. Analyzes workload characteristics and adjusts voltage/frequency across 64 independent power domains within 1ms. Achieves 18% average power savings across diverse AI workloads.",
      specs: "• RISC-V core architecture\n• 18M predictions/sec\n• <5kB model overhead\n• <1ms response time\n• 64 independent power domains",
      thermal: "52°C",
      maxTemp: "85°C",
      powerSavings: "18%",
      impact: "Neural controller reduces average datacenter power by 18% while maintaining 99.97% uptime SLA.",
      validation: "Deployed in beta across 500+ Azure nodes, 300+ GCP instances, 400+ AWS servers",
      timeline: "ML Training: Q1 2024 • Chip Integration: Q3 2024 • Deployment: Q4 2024",
    ...
    },
    {
      ...
      color: "#9d4edd",
      icon: "⚙️",
      details: "Gallium Nitride (GaN) transistors replace traditional silicon MOSFETs in a 16-phase voltage regulation module. Achieves 99.2% efficiency vs 92% in conventional VRMs, reducing power delivery losses by 60W at full 700W load.",
      specs: "• 99.2% power efficiency\n• 16-phase digital control\n• GaN FET technology\n• 60W loss reduction\n• 1MHz switching frequency",
      thermal: "55°C",
      maxTemp: "95°C",
      powerSavings: "8.6%",
      impact: "Ultra-efficient power delivery reduces waste heat by 60W, lowering cooling requirements and improving overall system efficiency.",
      validation: "Power efficiency validated by independent labs and datacenter operators",
      timeline: "GaN Selection: Q3 2023 • Design: Q1 2024 • Production: Q1 2025",
    ...
    },
    {
      ...
      color: "#ffd60a",
      icon: "🔢",
      details: "5th-generation Tensor Cores with hardware-accelerated 2:4 structured sparsity support. Doubles effective compute throughput for AI workloads by exploiting weight sparsity in neural networks. Achieves 2000 TFLOPS for FP8 training.",
      specs: "• 2000 TFLOPS FP8\n• 2:4 structured sparsity\n• 512 tensor cores\n• 2x AI performance boost\n• FP8/FP16/TF32 precision",
      thermal: "58°C",
      maxTemp: "90°C",
      powerSavings: "15%",
      impact: "Sparsity optimization delivers 2x effective performance for modern transformer architectures while reducing power by 15%.",
      validation: "Validated on GPT-4 training, DALL-E 3, Claude 3, and Stable Diffusion XL workloads",
      timeline: "Architecture: Q2 2023 • Silicon: Q1 2024 • Validation: Q4 2024",
  ...
  useEffect(() => {
    let scene, camera, renderer, gpu, gpuH100, hotspots = [], animationId, particles = [];
    ...
    const init = async () => {
      try {
        ...
        gpu = new THREE.Group();
        gpu.position.x = viewMode === 'Compare' ? -4 : 0;
        scene.add(gpu);

        // Create H100 for comparison
        gpuH100 = new THREE.Group();
        gpuH100.position.x = 4;
        ...
        // HBM3e Memory Stacks
        const memoryPositions = [[1.3, 0.35, 0], [-1.3, 0.35, 0], [0, 0.35, 1.1], [0, 0.35, -1.1]];
        ...
        const aiController = new THREE.Mesh(aiControllerGeometry, aiControllerMaterial);
        ...
        const buildH100 = () => {
          ...
          const h100MemPositions = [[1.5, 0.35, 0], [-1.5, 0.35, 0], [0, 0.35, 1.2], [0, 0.35, -1.2]];
          ...
          const h100Cooler = new THREE.Mesh(h100CoolerGeometry, h100CoolerMaterial);
        ...
        const onMouseMove = (event) => {
          ...
          if (isDragging) {
            ...
            hotspots.forEach(hotspot => {
              const scale = intersects.length > 0 && intersects[0].object.parent === hotspot ? 1.4 : 1;
        ...
        const onClick = (event) => {
          ...
          if (intersects.length > 0) {
            ...
            if (component) {
              ...
              isZooming = true;
              autoRotate = false;
              targetCameraPosition = new THREE.Vector3(...component.cameraPosition);
        ...
        sceneRef.current = { 
          scene, camera, renderer, gpu, gpuH100, hotspots,
          ...
          setRotationSpeed: (val) => { rotationSpeed = val; },
          resetCamera: () => {
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-b from-gray-950 via-teal-950 to-gray-950 relative overflow-hidden">
      <div ref={mountRef} className="w-full h-full" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }} />
      ...
      {loading && (
        <div className="absolute inset-0 flex items-center justify-center bg-gray-950">
          <div className="text-center">
            ...
            <p className="text-green-500 text-xl font-bold">Loading Interactive Showcase...</p>
          </div>
        </div>
      )}
      ...
      {/* Header */}
      <div className="absolute top-0 left-0 right-0 bg-gradient-to-b from-teal-900 to-transparent p-6 pointer-events-none" style={{ pointerEvents: 'none' }}>
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-white mb-1">
              NVIDIA <span className="text-green-400">Green GPU</span> - Interactive Technical Showcase
            </h1>
            <p className="text-gray-300 text-sm">Click [+] buttons to explore innovations</p>
          </div>
      ...
      <div className="absolute left-6 top-24 bg-gray-900 bg-opacity-90 backdrop-blur-md rounded-lg p-4 w-72 border border-teal-700" style={{ maxHeight: 'calc(100vh - 200px)', pointerEvents: 'auto' }}>
        <h3 className="text-white font-bold mb-2 text-sm uppercase tracking-wide">Innovation Map</h3>
          ...
          {components.map(comp => (
            <button
              ...
              onClick={() => {
                ...
                if (sceneRef.current) {
                  sceneRef.current.setTargetCamera(comp.cameraPosition, comp.cameraTarget);
                }
              }}
              ...
              style={{ 
                borderColor: selectedComponent?.id === comp.id ? comp.color : 'transparent'
              }}
            >
              <div 
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1 mb-1">
                  ...
                  <span className="text-white text-xs font-semibold truncate">{comp.name}</span>
                </div>
                <p className="text-teal-400 text-[10px] font-medium mb-1 leading-tight">{comp.subtitle}</p>
                <div className="flex items-center gap-2 text-[10px]">
                  <span className="text-green-400 font-semibold">{comp.powerSavings}</span>
                  <span className="text-gray-500">•</span>
                  <span className="text-cyan-400 font-semibold">{comp.thermal}</span>
                </div>
              </div>
            </button>
          ))}
      ...
      {/* Animation Controls */}
      <div className="absolute left-6 bg-gray-900 bg-opacity-90 backdrop-blur-md rounded-lg p-3 border border-teal-700 w-72" style={{ bottom: '24px', pointerEvents: 'auto' }}>
        <h3 className="text-white font-bold mb-2 text-xs uppercase tracking-wide">Animation Controls</h3>
      ...
      {/* Detail Panel */}
      {selectedComponent && (
        <div className="absolute right-6 bg-gray-900 bg-opacity-95 backdrop-blur-md rounded-xl p-5 w-[420px] border-2 shadow-2xl" 
             style={{ 
          ...
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-white font-bold text-xl">{selectedComponent.name}</h2>
                <p className="text-teal-400 text-sm font-semibold">{selectedComponent.subtitle}</p>
              </div>
            </div>
            <button 
              onClick={() => {
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed text-sm">{selectedComponent.details}</p>
            </div>

            <div className="bg-gray-800 bg-opacity-50 rounded-lg p-3">
              <h3 className="text-teal-400 font-bold mb-2 text-xs uppercase tracking-wide">Technical Specifications</h3>
              <p className="text-gray-300 whitespace-pre-line text-xs leading-relaxed font-mono">{selectedComponent.specs}</p>
            </div>

            <div className="bg-gray-800 bg-opacity-50 rounded-lg p-3">
              <h3 className="text-cyan-400 font-bold mb-2 text-xs uppercase tracking-wide">Thermal Profile</h3>
              <div className="flex items-center gap-3 mb-2">
                <div className="flex-1">
                  <div className="h-2.5 bg-gray-700 rounded-full overflow-hidden">
                    <div 
                      className="h-full bg-gradient-to-r from-cyan-500 to-cyan-400"
                      style={{ width: `${(parseFloat(selectedComponent.thermal) / parseFloat(selectedComponent.maxTemp)) * 100}%` }}
                    ></div>
                  </div>
                </div>
                <span className="text-cyan-400 font-bold text-base">{selectedComponent.thermal}</span>
              </div>
              <p className="text-gray-400 text-xs">Max operating temperature: {selectedComponent.maxTemp}</p>
            </div>

            <div className="bg-gray-800 bg-opacity-50 rounded-lg p-3">
              <h3 className="text-green-400 font-bold mb-2 text-xs uppercase tracking-wide">Performance Impact</h3>
              <div className="flex items-center gap-2 mb-2">
                <span className="text-2xl font-bold text-green-400">{selectedComponent.powerSavings}</span>
                <span className="text-xs text-gray-400">average power savings</span>
              </div>
              <p className="text-gray-300 text-xs">{selectedComponent.impact}</p>
            </div>
            ...
            <div className="bg-teal-900 bg-opacity-30 rounded-lg p-3 border border-teal-700">
              ...
              <p className="text-gray-300 text-xs leading-relaxed">{selectedComponent.validation}</p>
            </div>

            <div className="bg-gray-800 bg-opacity-30 rounded-lg p-2.5">
              <h3 className="text-yellow-400 font-bold mb-1.5 text-xs uppercase tracking-wide">Development Timeline</h3>
              <p className="text-gray-300 text-xs font-mono">{selectedComponent.timeline}</p>
            </div>
          </div>
        </div>
      )}
        ...
        <>
          <div className="absolute top-1/2 left-1/3 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none">
            <div className="bg-green-900 bg-opacity-90 backdrop-blur-md rounded-lg p-4 text-center border-2 border-green-500">
              <h3 className="text-green-400 font-bold text-2xl mb-2">Green GPU</h3>
              <div className="space-y-1 text-sm">
                <p className="text-white"><span className="text-green-400 font-bold">350W</span> Power</p>
                <p className="text-white"><span className="text-cyan-400 font-bold">65°C</span> Temp</p>
                <p className="text-white"><span className="text-yellow-400 font-bold">3nm</span> Process</p>
                <p className="text-green-400 font-bold text-lg mt-2">50% Less Power</p>
              </div>
            </div>
          </div>
          ...
          <div className="absolute top-1/2 right-1/4 transform translate-x-1/2 -translate-y-1/2 pointer-events-none">
            <div className="bg-red-900 bg-opacity-90 backdrop-blur-md rounded-lg p-4 text-center border-2 border-red-500">
              ...
              <div className="space-y-1 text-sm">
                <p className="text-white"><span className="text-red-400 font-bold">700W</span> Power</p>
                <p className="text-white"><span className="text-orange-400 font-bold">85°C</span> Temp</p>
                <p className="text-white"><span className="text-gray-400 font-bold">5nm</span> Process</p>
                <p className="text-red-400 font-bold text-lg mt-2">Legacy Design</p>
              </div>
            </div>
          </div>
        </>
